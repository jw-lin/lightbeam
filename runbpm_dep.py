...
optic = lant #optics.OpticSys([],njack)
...
xw_func = lambda z: (440 - 140) * z/zex + 140
yw_func = xw_func
...
u0 =  np.load("PSF0hi.npy") #np.load("tg_launch_his.npy")
...
u1_func = lambda xg,yg :  LPmodes.lpfield(xg,yg,0,1,6.5/2,wl0,ncore,nclad)
...
#####################
## mesh refinement ##
ucrit = 2.e-7 # the lower the slower!
remesh_every = 20 #^^^
